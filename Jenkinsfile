node{
  ...
  stage('Static Analysis'){
    sh 'mvn -f /var/lib/jenkins/workspace/build-test-calculator/Calculator/pom.xml sonar:sonar -Dsonar.host.url=http://localhost:9000 -Dlicense.skip=true -Dsonar.login="8d91ed7887f282e33c27ba8e2f481a185abcd1b4" '
  }
  stage('Test'){
